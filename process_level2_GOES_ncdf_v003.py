...
# NAME:
# :::::::::::::::::::::::::::::::::::::::::::::::
# process_level2_GOES_ncdf_v003.py
# :::::::::::::::::::::::::::::::::::::::::::::::
#
#  PROGRAM OVERVIEW:
...
#  Version 3.0   , Dated 2025-Dec-23rd                 Improve Visual and IR display.
#========================================================================================
...
#        ax.add_feature(cfeature.OCEAN)               # Fill ocean color
        ...
        if "01" or "02" or "03" in channel_id:
            satcmap='gray'
        ...
        img = ax.imshow(data.values, origin='upper', extent=(data.x.min(), data.x.max(), data.y.min(), data.y.max()), 
                          transform=geos, interpolation='none', cmap=satcmap) # Use 'viridis' or appropriate cmap
...
def main(exitvalue):
    ...
    #xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
    #
    PROGRAM_NAME="process_level2_GOES_ncdf_v003.py"
    #
    #xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
    exitvalue=0
